...
class InputHandler:
    @staticmethod
    def get_text_input():
        # Method to get user input for text creation or loading from a file
    ...
    def load_text_from_file():
        # Method to load text from a file, either from a default folder or user provided file path
        ...
        try:
            ...
            # If file successfully processed, attempt to remove it
...
if __name__ == "__main__":
    ...
    if content_type not in allowed_content_types:
        ...
        if text is not None:
            # Applying of case normalization functionality form Homework 3/4
